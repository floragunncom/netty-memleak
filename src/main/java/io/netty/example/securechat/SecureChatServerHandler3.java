 ...
 */
public class SecureChatServerHandler3 extends SimpleChannelUpstreamHandler {

    static final org.jboss.netty.channel.group.ChannelGroup channels = new org.jboss.netty.channel.group.DefaultChannelGroup();
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) {
        if(!e.getCause().getMessage().contains("Connection reset by peer")) {
